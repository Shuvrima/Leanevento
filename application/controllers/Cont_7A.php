<?php
	class Cont_7A extends CI_Controller{
		...
		public function ag_reg(){
			...
			if($this->form_validation->run()===FALSE){
				...
				$this->Post_model->create_agent($data);
				$this->Post_model->create_agent2($d);
				$this->ag_reg();
			}
